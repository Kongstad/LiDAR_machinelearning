...
* RGB layers were added through QGIS by using optical satellite maps and the tool LAStools - Keep in mind unlicensed LAStools will set intensity values to 0.
